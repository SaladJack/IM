 ...
 */
package net.openmob.mobilesdk.android;

import net.openmob.mobileimsdk.android.ClientCoreSDK;
import net.openmob.mobileimsdk.android.conf.ConfigEntity;
import net.openmob.mobilesdk.android.event.ChatBaseEventImpl;
import net.openmob.mobilesdk.android.event.ChatTransDataEventImpl;
import net.openmob.mobilesdk.android.event.MessageQoSEventImpl;
