...
import com.saladjack.im.protocal.c.PKeepAlive;
import com.saladjack.im.protocal.c.PLoginInfo;
import com.saladjack.im.protocal.s.PErrorResponse;
import com.saladjack.im.protocal.s.PKeepAliveResponse;
...
public class ProtocalFactory
{
	...
	public static Protocal createRecivedBack(int from_user_id, int to_user_id, String recievedMessageFingerPrint) {
		return new Protocal(ProtocalType.C.FROM_CLIENT_TYPE_OF_RECIVED, recievedMessageFingerPrint, from_user_id, to_user_id);
	}
}
