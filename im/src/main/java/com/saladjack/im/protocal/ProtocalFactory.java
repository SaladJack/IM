...
import com.ssm.core.protocal.c.PKeepAlive;
import com.ssm.core.protocal.c.PLoginInfo;
import com.ssm.core.protocal.s.PErrorResponse;
import com.ssm.core.protocal.s.PKeepAliveResponse;
import com.ssm.core.protocal.s.PLoginInfoResponse;
...
public class ProtocalFactory
{
	...
	{
		return new Protocal(ProtocalType.C.FROM_CLIENT_TYPE_OF_COMMON$DATA
				, dataContent, from_user_id, to_user_id);// 通用数据默认情况下也不需要QoS支持，需要QoS支持的将在由业务层自行设置
	}
